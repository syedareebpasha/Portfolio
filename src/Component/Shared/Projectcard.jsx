...
const Projectcard = ({ image, title, description, tag, githubUrl, liveUrl }) => {
  return (
    <div className="pc-card">
      <img src={image} alt={title} className="pc-img" />

      <div className="pc-num-badge">{tag}</div>
      ...
      <div className="pc-overlay">
        ...
        <div className="pc-btns">
          <a href={liveUrl} target="_blank" rel="noreferrer" className="pc-btn pc-btn-live">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="white">
              <path d="M19 19H5V5h7V3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"/>
            </svg>
            Live
          </a>
          <a href={githubUrl} target="_blank" rel="noreferrer" className="pc-btn pc-btn-gh">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="white">
